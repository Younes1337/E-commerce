...
class WebsiteController extends Controller
{
    ...
    {
        \Stripe\Stripe::setApiKey('sk_test_51LQ8l3LDwrRtCMLdlx0qLyT3eGztsExs8ueczglHTil9OIUsC0ZvHLPvCd21Aezp6l9kocz7Y0AMFBSrG8wmtri500PxAFMUi5');
        header('Content-Type: application/json');
        $YOUR_DOMAIN = 'http://127.0.0.1:8000';
        $checkout_session = \Stripe\Checkout\Session::create([
            //get the purchased items's information from the database  

            'payment_method_types' => ['card'],
            'line_items' => [[
                'price_data' => [
                    'currency' => 'usd',
                    'unit_amount' => 1975 * 100,
                    'product_data' => [
                        'name' => "Younes's Attachement",
